...
# Provisions an EC2 instance for makers21 server-v2 (mediasoup SFU + Express + WS).
...
if [ "$SG_ID" = "None" ] || [ -z "$SG_ID" ]; then
  ...
  # Backend HTTP/WS — server-v2 listens on 4000. If you front this with Fastly,
...
# The actual nginx.conf is shipped in the repo at server-v2/nginx/nginx.conf
...
echo "  4000              TCP   server-v2 backend"
...
echo ""
echo "  2. Set the announced address in server-v2/config.js to your Elastic IP."
echo ""
